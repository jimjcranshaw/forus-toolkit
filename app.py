...
TRANSLATIONS = {
    "EN": {
        ...
        "member_home_intro": (
            "### About This Toolkit\n\n"
            "The Forus Resilience and Support Toolkit is a practical resource built for Forus "
            "member platforms - national and regional civil society coalitions - navigating legal "
            "attack, funding shocks, reputational threats, and operational pressure.\n\n"
            "It was developed through research across 21 Forus member platforms, regional "
            "coalitions, and ecosystem organisations, drawing on direct experience of what has "
            "worked - and what has not - in real crises. The guidance is evidence-based, not "
            "theoretical.\n\n"
            "**What you will find here:** The toolkit is organised into six parts - crisis "
            "guides by type (Part 1), solidarity activation (Part 2), legal support (Part 3), "
            "emergency funding (Part 4), safe communications (Part 5), and diversification and "
            "mutualisation (Part 6). Each section is self-contained: go directly to whatever "
            "is most relevant to your situation.\n\n"
            "**How to use this page:** Fill in the form below to generate a personalised PDF "
            "version, selecting only the parts relevant to your organisation. If you need direct "
            "support or want to connect with a peer who has navigated a similar challenge, visit "
    ...
    "FR": {
        ...
        "member_home_intro": (
            ...
            "La Boîte à outils Résilience et Soutien de Forus est une ressource pratique "
            "destinée aux plateformes membres de Forus - coalitions nationales et régionales de "
            "la société civile - qui font face à des attaques législatives, des chocs de "
            "financement, des menaces réputationnelles et des pressions opérationnelles.\n\n"
            "Elle a été développée à partir de recherches menées auprès de 21 plateformes "
            "membres de Forus, coalitions régionales et organisations de l'écosystème, en "
            "s'appuyant sur l'expérience directe de ce qui a fonctionné - et de ce qui n'a pas "
            "fonctionné - dans de vraies crises. Les orientations sont fondées sur des preuves, "
            "pas sur la théorie.\n\n"
            "**Ce que vous trouverez ici :** La boîte à outils est organisée en six parties - "
            "guides de crise par type (Partie 1), activation de la solidarité (Partie 2), "
            "soutien juridique (Partie 3), financement d'urgence (Partie 4), communications "
            "sécurisées (Partie 5), et diversification et mutualisation (Partie 6). Chaque "
            "section est autonome : allez directement à ce qui est le plus pertinent pour "
            "votre situation.\n\n"
            "**Comment utiliser cette page :** Remplissez le formulaire ci-dessous pour générer "
            "un PDF personnalisé, en sélectionnant uniquement les parties pertinentes pour votre "
            "organisation. Si vous avez besoin d'un soutien direct ou souhaitez entrer en "
            "contact avec un pair, rendez-vous sur la page **Obtenir du soutien**."
        ),
        "feedback_member_desc": (
    ...
    "ES": {
        ...
        "member_home_intro": (
            "### Acerca de esta caja de herramientas\n\n"
            "La Caja de Herramientas de Resiliencia y Apoyo de Forus es un recurso práctico "
            "diseñado para las plataformas miembros de Forus - coaliciones nacionales y "
            "regionales de la sociedad civil - que navegan ataques legislativos, choques de "
            "financiación, amenazas reputacionales y presiones operativas.\n\n"
            "Fue desarrollada a través de investigaciones con 21 plataformas miembros de Forus, "
            "coaliciones regionales y organizaciones del ecosistema, basándose en la experiencia "
            "directa de lo que ha funcionado - y lo que no - en crisis reales. Las orientaciones "
            "son basadas en evidencia, no teóricas.\n\n"
            "**Lo que encontrará aquí:** La caja de herramientas está organizada en seis partes "
            "- guías de crisis por tipo (Parte 1), activación de la solidaridad (Parte 2), "
            "apoyo jurídico (Parte 3), financiación de emergencia (Parte 4), comunicaciones "
            "seguras (Parte 5), y diversificación y mutualización (Parte 6). Cada sección es "
            "independiente: vaya directamente a lo más relevante para su situación.\n\n"
            "**Cómo usar esta página:** Complete el formulario a continuación para generar un "
            "PDF personalizado, seleccionando solo las partes relevantes para su organización. "
            "Si necesita apoyo directo o desea conectar con un par, visite la página "
            "**Obtener apoyo**."
        ),
        "feedback_member_desc": (
...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    _SECRETARIAT_EMAIL = st.secrets.get("SECRETARIAT_EMAIL", "secretariat@forus-international.org")
